...
Οι προεπιλογές έχουν επιλεγεί ώστε το Pubsub Provider να μπορεί να εκτελείται δίπλα στο [Bitsocial Seeder](https://bitsocial.net/apps/bitsocial-seeder/) στο ίδιο VPS, χωρίς σύγκρουση στη θύρα swarm.
