...
Η πρώτη υπηρεσία που βασίζεται σε αυτό το μοντέλο είναι το Forge RPC από το [Bitsocial Forge](https://bitsocialforge.com/#forge-rpc), το οποίο βασίζεται στον σχεδιασμό του πρωτοκόλλου [Delegated IPNS](https://github.com/pkcprotocol/pkc-js/blob/master/docs/protocol/delegated-ipns.md).
