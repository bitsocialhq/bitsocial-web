...
Wartości domyślne dobrano tak, aby Pubsub Provider mógł działać na tym samym VPS obok [Bitsocial Seeder](https://bitsocial.net/apps/bitsocial-seeder/) bez konfliktu portu swarm.
