...
Первый сервис, построенный на этой модели, — Forge RPC от [Bitsocial Forge](https://bitsocialforge.com/#forge-rpc), основанный на дизайне протокола [Delegated IPNS](https://github.com/pkcprotocol/pkc-js/blob/master/docs/protocol/delegated-ipns.md).
