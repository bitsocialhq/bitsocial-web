...
Значения по умолчанию выбраны так, чтобы Pubsub Provider мог работать на одном VPS рядом с [Bitsocial Seeder](https://bitsocial.net/apps/bitsocial-seeder/) без конфликта swarm-портов.
