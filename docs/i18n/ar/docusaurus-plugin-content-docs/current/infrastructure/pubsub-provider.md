...
اختيرت القيم الافتراضية بحيث يمكن تشغيل مزوّد Pubsub إلى جانب [Bitsocial Seeder](https://bitsocial.net/apps/bitsocial-seeder/) على الخادم الافتراضي (VPS) نفسه دون تعارض في منفذ swarm.
