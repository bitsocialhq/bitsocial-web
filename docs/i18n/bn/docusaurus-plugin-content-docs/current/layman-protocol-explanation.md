...
এই মডেলের উপর নির্মিত প্রথম পরিষেবা হলো [Bitsocial Forge](https://bitsocialforge.com/#forge-rpc)-এর Forge RPC, যা [Delegated IPNS](https://github.com/pkcprotocol/pkc-js/blob/master/docs/protocol/delegated-ipns.md) প্রোটোকল নকশার উপর ভিত্তি করে তৈরি।
