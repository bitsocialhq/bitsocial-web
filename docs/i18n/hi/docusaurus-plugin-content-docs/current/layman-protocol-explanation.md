...
इस मॉडल पर निर्मित पहली सेवा [Bitsocial Forge](https://bitsocialforge.com/#forge-rpc) की Forge RPC है, जो [Delegated IPNS](https://github.com/pkcprotocol/pkc-js/blob/master/docs/protocol/delegated-ipns.md) प्रोटोकॉल डिज़ाइन पर आधारित है।
