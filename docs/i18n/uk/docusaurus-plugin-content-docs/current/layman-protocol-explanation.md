...
Першим сервісом, побудованим на цій моделі, є Forge RPC від [Bitsocial Forge](https://bitsocialforge.com/#forge-rpc), що ґрунтується на дизайні протоколу [Delegated IPNS](https://github.com/pkcprotocol/pkc-js/blob/master/docs/protocol/delegated-ipns.md).
