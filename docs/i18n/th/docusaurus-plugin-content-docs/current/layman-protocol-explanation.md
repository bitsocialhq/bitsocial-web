...
บริการแรกที่สร้างขึ้นบนโมเดลนี้คือ Forge RPC โดย [Bitsocial Forge](https://bitsocialforge.com/#forge-rpc) ซึ่งสร้างขึ้นบนการออกแบบโปรโตคอล [Delegated IPNS](https://github.com/pkcprotocol/pkc-js/blob/master/docs/protocol/delegated-ipns.md)
