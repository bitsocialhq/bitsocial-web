...
مقادیر پیش‌فرض چنان انتخاب شده‌اند که ارائه‌دهنده Pubsub بتواند کنار [Bitsocial Seeder](https://bitsocial.net/apps/bitsocial-seeder/) روی همان VPS و بدون تداخل پورت swarm اجرا شود.
